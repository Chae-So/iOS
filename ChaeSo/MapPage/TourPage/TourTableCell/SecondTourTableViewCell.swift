...
class SecondTourTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        firstLabel.font = UIFont(name: "Pretendard-Regular", size: 12*Constants.standartFont)
    ...
    func configure(a: String, b: UIImage) {
        if(b == UIImage(named: "phone")){
