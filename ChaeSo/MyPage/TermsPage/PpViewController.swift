...
class PpViewController: UIViewController, UIScrollViewDelegate {
    ...
    func bind(){
        ...
        termsViewModel.firstText
            .bind(to: ppLabel.rx.text)
            .disposed(by: disposeBag)

        termsViewModel.ppText
    ...
    func attribute(){
        ...
        ppLabel.font = UIFont(name: "Pretendard-Bold", size: 16*Constants.standartFont)
    ...
    func layout(){
        ...
        [ppLabel,contentLabel]
            .forEach { UILabel in
                scrollView.addSubview(UILabel)
            }
        
        ppLabel.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
        ...
        contentLabel.snp.makeConstraints { make in
            ...
            make.centerX.equalToSuperview()
            make.top.equalTo(ppLabel.snp.bottom).offset(15*Constants.standardHeight)
